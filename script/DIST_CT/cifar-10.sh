...
SAVE_DIR="save/DIST+CT/decay${DECAY}/alpha${ALPHA}/"
...
do
  ...
  --gamma 0.1 --momentum 0.9 --weight_decay 0.001 --early_stopping_patient 2000 --alpha $ALPHA \
  --decay $DECAY --warmup_epoch $WARMUP --selector 'DIST+CT' --data_dir $DATA_DIR --save_dir $SAVE_DIR
done
