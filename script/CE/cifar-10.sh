...
do
  ...
  --noise_type $NOISE_TYPE --noise_rate $NOISE_RATE --n_epoch 150 --selector GMM --alg dynamic_sample_selection \
  ...
  --warmup_epoch $WARMUP --alpha 0.1 --data_dir $DATA_DIR --save_dir save/CE
done
